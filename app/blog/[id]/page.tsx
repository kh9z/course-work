    ...
    return (
        <div className="w-[95%] mx-auto max-w-[1450px]">
            <div className="w-full h-[400px] relative mb-5">
                <Image fill alt="image for blog" src={post.img} className="object-cover"/>
            </div>
            ...
            <div className="flex md:gap-20 gap-5 relative mt-10 md:flex-row flex-col">
                ...
                <article>
                    ...
                    <div className="mt-5 flex gap-5 items-center">
                        <img src={post.user.image} alt={`Image of ${post.authorName}`} className="rounded-full w-[50px] h-[50px] object-cover"/>
